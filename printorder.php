...
//            	echo "1229 Jacklin Rd, Milpitas, CA 95036";
                ...
                echo "567 Tully Rd, San Jose, CA 95111";
            }
			?></br></p>
			<p align="center" style="font-size:20px"><?php
			 if ( isset($_SESSION['user_id']) && ($_SESSION['user_id'] == 6 || $_SESSION['username'] == 'vinhle')) { // apply full role with user khoa - id = 5
            ...
            <div style="width:400px; float:right;">
			   <p align="center" style="font-size:20px"><?php 
			   if ( isset($_SESSION['user_id']) && ($_SESSION['user_id'] == 5 || $_SESSION['username'] == 'khoa')) {
					echo "328 Vo Van Kiet Stree, District 1, HCM";
			   }
			   ?></p>
      			<p align="center" style="font-size:20px"><?php
      				echo "<strong>Mr.Khoa: </strong>0938-622-922";
